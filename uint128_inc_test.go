...
func TestUint128_Inc(t *testing.T) {
	...
	tests := []struct{
		...
		},
		{
			...
			Expected: bits128.Uint128FromUintsLittleEndian([2]uint{0x0000000000000005,0x0000000000000000}),
		},
		{
			Value:    bits128.Uint128FromUintsLittleEndian([2]uint{0x0000000000000006,0x0000000000000000}),
			Expected: bits128.Uint128FromUintsLittleEndian([2]uint{0x0000000000000007,0x0000000000000000}),
		},
		{
			Value:    bits128.Uint128FromUintsLittleEndian([2]uint{0x0000000000000008,0x0000000000000000}),
		...
		{
			Value:    bits128.Uint128FromUintsLittleEndian([2]uint{0x825C99712043E01C,0xED7BA4708E54465E}),
			Expected: bits128.Uint128FromUintsLittleEndian([2]uint{0x825C99712043E01D,0xED7BA4708E54465E}),
		},



		{
			Value:    bits128.Uint128FromUintsLittleEndian([2]uint{0xFFFFFFFFFFFFFFFA,0xFFFFFFFFFFFFFFFF}),
